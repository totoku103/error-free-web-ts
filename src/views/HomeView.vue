<template>
    <div>
        <button class="bg-blue-400 hover:bg-blue-700 rounded py-1 px-1 m-3">AAAAA</button>
        <button class="bg-blue-400 hover:bg-blue-700 rounded py-1 px-1">BBBBB</button>
    </div>
    ...
    window.Smart('#grid', class {
        get properties() {
            return <Grid>{
                ...
                columns: [
                    {label: 'Country', dataField: 'id', sortOrder: 'desc'},
                    {label: 'Country', dataField: 'name', sortOrder: 'desc'},
                    {label: 'Country', dataField: 'type', sortOrder: 'desc'},
                    {label: 'Country', dataField: 'calories', sortOrder: 'desc'},
                    {label: 'Country', dataField: 'totalfat', sortOrder: 'desc'},
                    {label: 'Country', dataField: 'protein', sortOrder: 'desc'},
                ]
            }
        }
    });
